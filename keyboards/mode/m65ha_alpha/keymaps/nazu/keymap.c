...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    ...
    KC_LCTL,  KC_LGUI, KC_LALT,                                KC_SPC,                                   KC_RALT,  MO(_FN1), KC_LEFT,  KC_DOWN,  KC_RGHT   //10
  ),
   ...
   */
    ...
    _______,  QWERTY,  CLMKDH,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          KC_SWAP,
