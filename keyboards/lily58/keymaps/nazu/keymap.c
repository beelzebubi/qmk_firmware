 ...
 */
 ...
 [_QWERTZ] = LAYOUT(
  ...
  KC_TAB,   DE_Q,   KC_W,    KC_E,    KC_R,    KC_T,                     DE_Z,   KC_U,    KC_I,    KC_O,    KC_P,    DE_UDIA,
  KC_LCTRL, DE_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,   KC_J,    KC_K,    KC_L,    DE_ODIA, DE_ADIA,
  KC_LSFT,  DE_Y,   KC_X,    KC_C,    KC_V,    KC_B,  DE_HASH,  DE_PLUS, KC_N,   KC_M,    DE_COMM, DE_DOT,  DE_MINS, KC_RSFT,
 ...
 */
  [_ADJUST] = LAYOUT(
  RESET,   XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX,    XXXXXXX,                    RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, KC_QWERTZ, KC_NEO,  KC_COLEMAK, XXXXXXX,                    RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, XXXXXXX, XXXXXXX,
