...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTZ] = LAYOUT_60_iso_bs_rshift(
    ...
    TD_CAPS, DE_LABK, DE_Y,    DE_X,    DE_C,    DE_V,    DE_B,    DE_N,    DE_M,    DE_COMM, DE_DOT,  DE_MINS, KC_RSFT, MO(_FN2),
  ...
  [_COLEMAK] = LAYOUT_60_iso_bs_rshift(
    ...
    TD_CAPS, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    CM_BSLS, KC_K,    KC_H,    CM_COMM, CM_DOT,  CM_SLSH, KC_RSFT, MO(_FN2),
    KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                    KC_RALT, MO(_FN1),KC_APP,  KC_LCTL
  ),
